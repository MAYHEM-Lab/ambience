...
1. Figure out what time is it, relative to some _epoch_
2. Be notified when a certain amount of time passes
...
[source,cpp,indent=0]
----
include::{rootdir}/src/drivers/include/common/alarm.hpp[lines=63]
    ...
----
...
[source,cpp,indent=0]
----
include::{rootdir}/src/drivers/include/common/alarm.hpp[lines=16..28]
----
...
`sleep_for` basically constructs an <<synchronization#events,event>>, and 