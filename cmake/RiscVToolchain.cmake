...
set(CMAKE_ASM_COMPILER_TARGET "riscv32-none-elf")
set(CMAKE_CXX_COMPILER_TARGET "riscv32-none-elf")
set(CMAKE_C_COMPILER_TARGET "riscv32-none-elf")

include(FindToolchain)
find_llvm_toolchain(TRIPLE aarch64-none-elf SET)

set(CMAKE_TRY_COMPILE_TARGET_TYPE STATIC_LIBRARY)

set(TOS_STM32_FLAGS "-target riscv32-none-elf -march=rv32i")
