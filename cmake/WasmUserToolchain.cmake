...
set(CMAKE_ASM_COMPILER_TARGET "wasm32")
set(CMAKE_CXX_COMPILER_TARGET "wasm32")
set(CMAKE_C_COMPILER_TARGET "wasm32")

include(FindToolchain)
find_llvm_toolchain(TRIPLE wasm32 SET)

set(CMAKE_TRY_COMPILE_TARGET_TYPE STATIC_LIBRARY)

set(TOS_STM32_FLAGS "-target wasm32 -fno-optimize-sibling-calls")

set(CMAKE_LINKER ${TOOLCHAIN_WASM_LD})
message(STATUS ${CMAKE_LINKER})
set(CMAKE_CXX_LINK_EXECUTABLE "<CMAKE_LINKER> -o <TARGET> --lto-O3 --strip-all --gc-sections <OBJECTS> <LINK_LIBRARIES>")
