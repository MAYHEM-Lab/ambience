...
public:
    ...
    file open(const std::string& path) const {
        ...
        if (!entry_ptr || !entry_ptr->is_file()) {
            tos_debug_print("no such file or directory");
            while(true);
...
target_compile_features(cmrc-base INTERFACE cxx_std_14)
#target_compile_options(cmrc-base INTERFACE "-std=c++14")
...
function(cmrc_add_resource_library name)
    ...
    target_link_libraries(${name} PUBLIC cmrc::base tos_core)
