...
TUSBFunction *USBDeviceFactoryGetDevice (TUSBFunction *pParent, TString *pName)
{
	...
	{
		TUSBStandardHub *pDevice = (TUSBStandardHub *) tos_malloc (sizeof (TUSBStandardHub));
		assert (pDevice != 0);
	...
	{
		TUSBBulkOnlyMassStorageDevice *pDevice = (TUSBBulkOnlyMassStorageDevice *) tos_malloc (sizeof (TUSBBulkOnlyMassStorageDevice));
		assert (pDevice != 0);
	...
	{
		TUSBKeyboardDevice *pDevice = (TUSBKeyboardDevice *) tos_malloc (sizeof (TUSBKeyboardDevice));
		assert (pDevice != 0);
	...
	{
		TUSBMouseDevice *pDevice = (TUSBMouseDevice *) tos_malloc (sizeof (TUSBMouseDevice));
		assert (pDevice != 0);
	...
	{
		TSMSC951xDevice *pDevice = (TSMSC951xDevice *) tos_malloc (sizeof (TSMSC951xDevice));
		assert (pDevice != 0);
	...
	{
		TLAN7800Device *pDevice = (TLAN7800Device *) tos_malloc (sizeof (TLAN7800Device));
		assert (pDevice != 0);
    ...
    {
        TUSBGamePadDevice *pDevice = (TUSBGamePadDevice *) tos_malloc (sizeof (TUSBGamePadDevice));
        assert (pDevice != 0);
	...
	{
		TUSBMIDIDevice *pDevice = (TUSBMIDIDevice *) tos_malloc (sizeof (TUSBMIDIDevice));
		assert (pDevice != 0);
