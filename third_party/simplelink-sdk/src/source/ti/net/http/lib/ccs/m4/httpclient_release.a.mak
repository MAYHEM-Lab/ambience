...
package/lib/lib/ccs/m4/httpclient_release/httpclient.oem4: httpclient.c lib/ccs/m4/httpclient_release.a.mak
	...
	$(RM) $@
	@$(MSG) clem4 $< ...
	$(ti.targets.arm.elf.M4.rootDir)/bin/armcl -c  -qq -pdsw225 --endian=little -mv7M4 --float_support=vfplib --abi=eabi -eo.oem4 -ea.sem4  -ms -g --c99   -I/vagrant/Q3_ENG_SDK_250919/sdk_root/source/ti/posix/ccs -Dxdc_target_name__=M4 -Dxdc_target_types__=ti/targets/arm/elf/std.h -Dxdc_bld__profile_release -Dxdc_bld__vers_1_0_18_12_3 -O2  $(XDCINCS) -I$(ti.targets.arm.elf.M4.rootDir)/include  -fs=./package/lib/lib/ccs/m4/httpclient_release -fr=./package/lib/lib/ccs/m4/httpclient_release -fc $<
	$(MKDEP) -a $@.dep -p package/lib/lib/ccs/m4/httpclient_release -s oem4 $< -C   -qq -pdsw225 --endian=little -mv7M4 --float_support=vfplib --abi=eabi -eo.oem4 -ea.sem4  -ms -g --c99   -I/vagrant/Q3_ENG_SDK_250919/sdk_root/source/ti/posix/ccs -Dxdc_target_name__=M4 -Dxdc_target_types__=ti/targets/arm/elf/std.h -Dxdc_bld__profile_release -Dxdc_bld__vers_1_0_18_12_3 -O2  $(XDCINCS) -I$(ti.targets.arm.elf.M4.rootDir)/include  -fs=./package/lib/lib/ccs/m4/httpclient_release -fr=./package/lib/lib/ccs/m4/httpclient_release
	-@$(FIXDEP) $@.dep $@.dep
