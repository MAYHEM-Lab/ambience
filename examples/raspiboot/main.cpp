...
void exc_handler(uint32_t type, uint32_t esr, uint32_t elr, uint32_t spsr, uint32_t far)
{
    ...
    switch(type) {
    case 0: LOG("Synchronous"); break;
    case 1: LOG("IRQ"); break;
    case 2: LOG("FIQ"); break;
    case 3: LOG("SError"); break;
    }
    LOG(": ");
    ...
    if(esr>>26==0b100100 || esr>>26==0b100101) {
        LOG(", ");
        switch((esr>>2)&0x3) {
        case 0: LOG("Address size fault"); break;
        case 1: LOG("Translation fault"); break;
        case 2: LOG("Access flag fault"); break;
        case 3: LOG("Permission fault"); break;
        }
        switch(esr&0x3) {
        case 0: LOG(" at level 0"); break;
        case 1: LOG(" at level 1"); break;
        case 2: LOG(" at level 2"); break;
        case 3: LOG(" at level 3"); break;
        }
    }
    // dump registers
    LOG(":\n  ESR_EL1 ");
...
void tos_main() {
    tos::launch(stack, [] {
        ...
        tos::println(uart, tos::itoa(reinterpret_cast<uint64_t>(&bcm2837::INTERRUPT_CONTROLLER->enable_irq_1), 16));
        ...
        while (true)
        {
            ...
            tos::println(uart, bcm2837::SYSTEM_TIMER->counter_lo, bcm2837::SYSTEM_TIMER->compare1);
        }
