...
template <class LogT>
static void ble_stack_init(LogT&& log)
{
    ret_code_t err_code;
...
auto ble_task = [](auto& g)
{
    ...
    tos::println(usart, "yo", f.x);

    ble_stack_init(usart);
    tos::println(usart, "ble initd");
    gap_params_init();
