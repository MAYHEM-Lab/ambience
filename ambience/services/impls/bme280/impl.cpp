...
using driv = tos::device::bme280::driver<tos::ae::services::i2c::sync_server* const,
                                         decltype(delay)>;
struct impl final : tos::ae::services::temp_sensor::sync_server {
    impl(tos::ae::services::i2c::sync_server& i2c)
        : m_driver{{0x1}, &i2c, delay} {
    }
...
extern "C" tos::ae::services::temp_sensor::sync_server*
init_bme280(tos::ae::services::i2c::sync_server& i2c) {
    return new impl{i2c};
}