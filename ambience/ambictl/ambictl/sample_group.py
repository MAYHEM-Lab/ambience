...
def sample_deployment() -> [DeployNode]:
    ...
    basic_calc = calc_if.implement("basic_calc", cmake_target="basic_calc", sync=False, extern=False,
                                   deps={"logger": logger_if, "alarm": alarm_if, "fs": fs_if, "db": db_if})
    ...
    calc = basic_calc.instantiate("calc", deps={"logger": logger, "alarm": alarm, "fs": fs, "db": sqlite})
